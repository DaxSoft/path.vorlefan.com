...
This function access the [stream methods](/docs/api/stream)
...
This function access the [io methods](/docs/api/io)
...
This function access the [json methods](/docs/api/json)
